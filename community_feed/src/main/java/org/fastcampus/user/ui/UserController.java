...
public class UserController {
    ...
    private final JpaUserListQueryRepository queryRepository;
    ...
    @GetMapping("/{userId}")
    public Response<User> getUser(@PathVariable(name = "userId") Long userId) {
    ...
    public Response<List<GetUserListResponseDto>> getFollowingList(
        ...
        List<GetUserListResponseDto> result = queryRepository.getFollowingUserList(userId);
    ...
    public Response<List<GetUserListResponseDto>> getFollowerList(
        @PathVariable(name = "userId") Long userId) {
        List<GetUserListResponseDto> result = queryRepository.getFollowerUserList(userId);
        return Response.ok(result);
    }
}
