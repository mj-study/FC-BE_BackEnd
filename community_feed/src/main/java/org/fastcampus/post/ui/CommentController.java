...
public class CommentController {
    ...
    @PatchMapping("/{commendId}")
    public Response<Long> updateComment(@PathVariable(name = "commendId") Long commendId,
        @RequestBody UpdateCommentRequestDto dto) {
        Comment comment = commentService.updateComment(commendId, dto);
        return Response.ok(comment.getId());
    }
